...
5. **Label discipline.** Ensure the PR carries `task-1`, `service-rust-basic-api`, and `run-play-workflow-template-wh9ts`. Apply or remove `ready-for-qa` based on CI status.
