...
7. **Create the PR**: `gh pr create ...` with task-specific title/body, add labels (`task-1`, `service-rust-basic-api`, `run-play-workflow-template-47w2k`), and capture test results (reuse the narrative above in the PR body).
