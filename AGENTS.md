...
5. **Label discipline.** Ensure the PR carries `task-1`, `service-rust-basic-api`, and `run-play-workflow-template-5kkvc`. Apply or remove `ready-for-qa` based on CI status.
