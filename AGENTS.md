...
6. **Create the PR** with `gh pr create`, ensure labels (`task-1`, `service-rust-basic-api`, `run-play-workflow-template-rnpms`) exist (create them if missing), and attach logs/output.
